groups = [
    ...
    },
    {
        ...
        "description": null,
        "users": [
            "sunil.subramanya@infracloud.io",
            "harsha.chitale@infracloud.io",
            "shubhada.rathor@infracloud.io",
            "khushboo.khatter@infracloud.io",
            "pratheesh.p@infracloud.io",
            "rounak.upadhye@infracloud.io",
            "mahaboob.basha@infracloud.io",
            "runit.misra@infracloud.io",
            "rucha.bhange@infracloud.io",
            "harshal.yadwadkar@infracloud.io",
            "burhanuddin.shaikh@infracloud.io",
            "ubaid.ansari@infracloud.io",
            "nitin.naidu@infracloud.io",
            "rajesh.kumar@infracloud.io",
            "nishant.barola@infracloud.io",
            "sudarshan.sr@infracloud.io",
            "inesh.shyamala@infracloud.io",
            "bhagyesh.soni@infracloud.io",
            "dipali.bhujbal@infracloud.io",
            "jeet.desai@infracloud.io",
            "dhruv.mewada@infracloud.io",
            "pavan.ng@infracloud.io",
            "dada.gore@infracloud.io"
        ]
    },
    {
